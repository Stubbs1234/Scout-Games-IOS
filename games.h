...
@interface games : UIViewController <UIPrintInteractionControllerDelegate, UIActionSheetDelegate, MFMailComposeViewControllerDelegate, UITableViewDelegate, HomeModelProtocol> {
...
@property (strong, nonatomic) IBOutlet UIButton *backBtnMain;
